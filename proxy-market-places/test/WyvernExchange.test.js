...
//    erc20 = await ERC20.new();          //strange problems with deploy
    testERC20 = await TestERC20.new();    //try to use test ERC20
...
//      console.log("Gas used wyvernExchange for ERC20:", tx.receipt.gasUsed);
    ...
    async function prepareWywernNFT_ERC20(_buyMaker, _sellMaker, _sellFeeRecipient) {
    	const addrs = [
          ...
          "0x0000000000000000000000000000000000000000",
          "0x5206e78b21ce315ce284fb24cf05e0585a93b1d9",
          _sellMaker,// "0x9133d618c4f756dc231462a70701757d0af9f1bb", sellMaker
          "0x0000000000000000000000000000000000000000",
          _sellFeeRecipient,//"0x5b3256965e7c3cf26e11fcaf296dfc8807c01073", //sell feeRecipient (10)
          "0x45b594792a5cdc008d0de1c1d69faa3d16b3ddc1",
          "0x0000000000000000000000000000000000000000",
