...
const TestAuctionHouse721 = artifacts.require("TestAuctionHouse721");
...
contract("AuctionHouse721", accounts => {
  ...
  beforeEach(async () => {
    ...
    /*Auction*/
    testAuctionHouse = await deployProxy(TestAuctionHouse721, [protocol, royaltiesRegistry.address, transferProxy.address, erc20TransferProxy.address, 300, 100], { initializer: "__AuctionHouse721_init" });
  });
