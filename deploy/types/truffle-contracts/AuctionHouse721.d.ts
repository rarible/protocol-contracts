...
export interface AuctionHouse721Contract
  extends Truffle.Contract<AuctionHouse721Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AuctionHouse721Instance>;
}
...
export interface AuctionHouse721Instance extends Truffle.ContractInstance {
