...
export interface ExchangeV2CoreContract
  extends Truffle.Contract<ExchangeV2CoreInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ExchangeV2CoreInstance>;
}
...
export interface ExchangeV2CoreInstance extends Truffle.ContractInstance {
