...
export interface ERC721LazyMinimalContract
  extends Truffle.Contract<ERC721LazyMinimalInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ERC721LazyMinimalInstance>;
}
...
export interface ERC721LazyMinimalInstance extends Truffle.ContractInstance {
  /**
   * See {IERC721-approve}.
   */
  approve: {
