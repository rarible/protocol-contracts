...
export interface ERC1155RaribleBeaconMetaContract
  extends Truffle.Contract<ERC1155RaribleBeaconMetaInstance> {
  "new"(
    impl: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC1155RaribleBeaconMetaInstance>;
}
...
export interface ERC1155RaribleBeaconMetaInstance
