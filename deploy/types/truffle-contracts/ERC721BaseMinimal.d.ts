...
export interface ERC721BaseMinimalContract
  extends Truffle.Contract<ERC721BaseMinimalInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ERC721BaseMinimalInstance>;
}
...
export interface ERC721BaseMinimalInstance extends Truffle.ContractInstance {
  /**
   * See {IERC721-approve}.
   */
  approve: {
