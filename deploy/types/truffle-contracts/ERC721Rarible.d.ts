...
export interface ERC721RaribleContract
  extends Truffle.Contract<ERC721RaribleInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ERC721RaribleInstance>;
}
...
export interface ERC721RaribleInstance extends Truffle.ContractInstance {
  /**
   * See {IERC721-approve}.
   */
  approve: {
