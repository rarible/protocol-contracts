...
export interface ERC721RaribleMinimalContract
  extends Truffle.Contract<ERC721RaribleMinimalInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<ERC721RaribleMinimalInstance>;
}
...
export interface ERC721RaribleMinimalInstance extends Truffle.ContractInstance {
  /**
