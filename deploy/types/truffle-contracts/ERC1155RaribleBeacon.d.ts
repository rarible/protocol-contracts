...
export interface ERC1155RaribleBeaconContract
  extends Truffle.Contract<ERC1155RaribleBeaconInstance> {
  "new"(
    impl: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC1155RaribleBeaconInstance>;
}
...
export interface ERC1155RaribleBeaconInstance extends Truffle.ContractInstance {
  /**
