...
export interface ERC721RaribleBeaconContract
  extends Truffle.Contract<ERC721RaribleBeaconInstance> {
  "new"(
    impl: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC721RaribleBeaconInstance>;
}
...
export interface ERC721RaribleBeaconInstance extends Truffle.ContractInstance {
  /**
