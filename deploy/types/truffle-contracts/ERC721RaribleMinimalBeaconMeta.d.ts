...
export interface ERC721RaribleMinimalBeaconMetaContract
  extends Truffle.Contract<ERC721RaribleMinimalBeaconMetaInstance> {
  "new"(
    impl: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC721RaribleMinimalBeaconMetaInstance>;
}
...
export interface ERC721RaribleMinimalBeaconMetaInstance
