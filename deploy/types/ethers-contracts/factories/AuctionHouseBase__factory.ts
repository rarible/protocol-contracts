...
export class AuctionHouseBase__factory {
  static readonly abi = _abi;
  static createInterface(): AuctionHouseBaseInterface {
    return new utils.Interface(_abi) as AuctionHouseBaseInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AuctionHouseBase {
    return new Contract(address, _abi, signerOrProvider) as AuctionHouseBase;
  }
}
