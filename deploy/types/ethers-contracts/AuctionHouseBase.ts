...
export interface AuctionHouseBaseInterface extends utils.Interface {
  functions: {
...
export interface AuctionHouseBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuctionHouseBaseInterface;
