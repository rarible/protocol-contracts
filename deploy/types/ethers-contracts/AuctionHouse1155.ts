...
export interface AuctionHouse1155Interface extends utils.Interface {
  functions: {
    ...
    "__AuctionHouse1155_init(address,address,address,address,uint64,uint96)": FunctionFragment;
    "startAuction(address,uint96,uint256,address,uint96,bytes4,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__AuctionHouse1155_init",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
...
export interface AuctionHouse1155 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuctionHouse1155Interface;
  ...
  functions: {
    ...
    startAuction(
      ...
      _sellTokenValue: PromiseOrValue<BigNumberish>,
