...
export interface PunkTransferProxyInterface extends utils.Interface {
  functions: {
...
export interface PunkTransferProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PunkTransferProxyInterface;
