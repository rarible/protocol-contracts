...
export interface ERC721LazyMintTransferProxyInterface extends utils.Interface {
  functions: {
...
export interface ERC721LazyMintTransferProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721LazyMintTransferProxyInterface;
