...
export interface AuctionHouseBase721Interface extends utils.Interface {
  functions: {
...
export interface AuctionHouseBase721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuctionHouseBase721Interface;
