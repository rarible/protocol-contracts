...
export interface ERC1155LazyMintTransferProxyInterface extends utils.Interface {
  functions: {
...
export interface ERC1155LazyMintTransferProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155LazyMintTransferProxyInterface;
