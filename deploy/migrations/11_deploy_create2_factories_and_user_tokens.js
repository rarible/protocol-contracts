...
async function deployMinimal721(transferProxy, erc721LazyMintTransferProxy) {
  ...
  const erc721minimal = await getProxyImplementation(ERC721RaribleMinimal, network)
...
function deployUser721(transferProxy, erc721LazyMintTransferProxy){
  ...
  module.exports = async function (deployer, network) {
    ...
    await deployMinimal721(transferProxy, erc721LazyMintTransferProxy)
