...
export interface LSSVMPairEnumerableERC20Interface extends utils.Interface {
  functions: {
...
export interface LSSVMPairEnumerableERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LSSVMPairEnumerableERC20Interface;
