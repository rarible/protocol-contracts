...
export interface LSSVMPairMissingEnumerableETHInterface
...
export interface LSSVMPairMissingEnumerableETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LSSVMPairMissingEnumerableETHInterface;
