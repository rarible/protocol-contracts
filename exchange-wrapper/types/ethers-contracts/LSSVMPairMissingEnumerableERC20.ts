...
export interface LSSVMPairMissingEnumerableERC20Interface
...
export interface LSSVMPairMissingEnumerableERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LSSVMPairMissingEnumerableERC20Interface;
  ...
  functions: {
    ...
    /**
     * When safeTransfering an ERC721 in, we add ID to the idSet if it's the same collection used by pool. (As it doesn't auto-track because no ERC721Enumerable)
     */
    onERC721Received(
      arg0: PromiseOrValue<string>,
      arg1: PromiseOrValue<string>,
    ...
    /**
     * See LSSVMPairCloner for an explanation on how this works
