...
import "@rarible/exchange-v2/contracts/ExchangeV2Core.sol";
import "@rarible/transfer-manager/contracts/RaribleTransferManager.sol";
import "@rarible/royalties/contracts/IRoyaltiesProvider.sol";

contract ExchangeV2Test is ExchangeV2Core, RaribleTransferManager {
    function __ExchangeV2_init(
        ...
        __TransferExecutor_init_unchained(address(_transferProxy), address(_erc20TransferProxy));
