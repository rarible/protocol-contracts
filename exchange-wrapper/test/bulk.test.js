...
contract("RaribleExchangeWrapper default cases", accounts => {
  ...
  beforeEach(async () => {    
    ...
    // deploying wrapper
    bulkExchange = await ExchangeBulkV2.new(ZERO_ADDRESS, exchangeV2.address, seaport.address, x2y2.address, looksRareExchange.address, routerSudoSwap.address, seaport.address, ZERO_ADDRESS, [])
  });
