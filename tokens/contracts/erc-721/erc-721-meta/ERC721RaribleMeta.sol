...
import "./ERC721RaribleBase.sol";

contract ERC721RaribleMeta is ERC721RaribleBase, EIP712MetaTransaction {
    ...
    function __ERC721RaribleMeta_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        __ERC721RaribleBase_init(_name, _symbol, baseURI, contractURI);
