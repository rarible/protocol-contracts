...
abstract contract ERC1155RaribleUserBase is OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {

    string public name;
    string public symbol;

    function __ERC1155RaribleUserBase_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) internal initializer {
