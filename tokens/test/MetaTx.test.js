...
contract("ERC721MetaTxTokenTest", accounts => {
  ...
  beforeEach(async () => {
    ...
    erc721UserNoMetaTx = await deployProxy(ERC721NoMetaTx, ["Rarible", "RARI", "ipfs:/", "", []], { initializer: '__ERC721RaribleUser_init' });
    erc721UserWithMetaTx = await deployProxy(ERC721MetaTx, ["Rarible", "RARI", "ipfs:/", "", []], { initializer: '__ERC721RaribleUserMeta_init' });
    ...
    erc1155UserNoMetaTx = await deployProxy(ERC1155NoMetaTx, ["Rarible", "RARI", "ipfs:/", "", []], { initializer: '__ERC1155RaribleUser_init' });
    erc1155UserWithMetaTx = await deployProxy(ERC1155MetaTx, ["Rarible", "RARI", "ipfs:/", "", []], { initializer: '__ERC1155RaribleUserMeta_init' });
