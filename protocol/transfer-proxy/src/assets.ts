// <ai_context> TypeScript port of scripts/assets.js for transfer-proxy package. Provides asset class identifiers and simple ABI encoding helpers using pure TypeScript/BigInt for use in tests and SDKs without relying on web3.</ai_context>
