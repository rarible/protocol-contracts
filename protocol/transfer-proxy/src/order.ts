// <ai_context> TypeScript port of scripts/order.js for transfer-proxy package. Exposes helpers to build AssetType, Asset, and Order structs plus an EIP-712 signing helper using Ethers v6, matching the original JS logic.</ai_context>
