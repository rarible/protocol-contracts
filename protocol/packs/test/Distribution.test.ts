...
describe("Distribution / Monte-Carlo (PackManager + NftPool)", function () {
  ...
  const FLOOR_PRICES: Record<PoolLevelId, bigint> = {
    [PoolLevel.Common]: ethers.parseEther("0.03195"), // 0 - 0.05325 ETH range
    [PoolLevel.Rare]: ethers.parseEther("0.1065"), // 0.05325 - 0.213 ETH range
    [PoolLevel.Epic]: ethers.parseEther("0.5325"), // 0.213 - 1.065 ETH range
    [PoolLevel.Legendary]: ethers.parseEther("2.6625"), // 1.065 - 5.325 ETH range
    [PoolLevel.UltraRare]: ethers.parseEther("10.65"), // 5.325+ ETH range
  };
