...
const WETH_UNWRAP = id("WETH_UNWRAP");
...
module.exports = { id, ETH, ERC20, ERC721, ERC721_LAZY, ERC1155, ERC1155_LAZY, ORDER_DATA_V1, ORDER_DATA_V2, TO_MAKER, TO_TAKER, PROTOCOL, ROYALTY, ORIGIN, PAYOUT, CRYPTO_PUNKS, WETH_UNWRAP, COLLECTION, LOCK, UNLOCK, TO_LOCK, enc }
