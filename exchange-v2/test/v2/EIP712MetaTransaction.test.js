...
//    ZERO_ADDRESS instead of transferManager possible, because transferManager is not used here
    testContract = await deployProxy(ExchangeMetaV2, [ZERO_ADDRESS], { initializer: "__ExchangeV2_init" });
    testingSimpleContract = await deployProxy(ExchangeSimpleV2, [], { initializer: "__ExchangeSimpleV2_init" });
