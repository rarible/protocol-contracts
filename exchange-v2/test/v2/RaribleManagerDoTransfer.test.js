...
contract("RaribleTransferManagerTest:doTransferTest()", accounts => {
	...
	let community = accounts[8];//todo проверить, что на community переводится все
	let erc721;
	let erc1155;
	let erc721TokenId1 = 53;
	let erc1155TokenId1 = 54;
	let erc1155TokenId2 = 54;
	...
	beforeEach(async () => {
		...
		await testing.setWalletForToken(t2.address, protocol);
	});

	describe("Run doTransfers(). ", () => {
