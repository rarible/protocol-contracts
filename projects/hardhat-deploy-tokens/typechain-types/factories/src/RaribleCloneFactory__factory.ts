...
import type {
  RaribleCloneFactory,
  RaribleCloneFactoryInterface,
} from "../../src/RaribleCloneFactory";
...
type RaribleCloneFactoryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: RaribleCloneFactoryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class RaribleCloneFactory__factory extends ContractFactory {
  constructor(...args: RaribleCloneFactoryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<RaribleCloneFactory> {
    return super.deploy(overrides || {}) as Promise<RaribleCloneFactory>;
  }
  ...
  override attach(address: string): RaribleCloneFactory {
    return super.attach(address) as RaribleCloneFactory;
  }
  override connect(signer: Signer): RaribleCloneFactory__factory {
    return super.connect(signer) as RaribleCloneFactory__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RaribleCloneFactoryInterface {
    return new utils.Interface(_abi) as RaribleCloneFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RaribleCloneFactory {
    return new Contract(address, _abi, signerOrProvider) as RaribleCloneFactory;
  }
}
