...
export interface IERC721EnumerableUpgradeableInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "balanceOf" | "getApproved" | "isApprovedForAll" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "transferFrom" | "totalSupply" | "tokenOfOwnerByIndex" | "tokenByIndex"): FunctionFragment;
