...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  console.log('\n=== Starting DropERC1155 Deployment ===');
  ...
  console.log('\nDeploying DropERC1155 contract...');
  const deployResult = await deploy('DropERC1155', {
    from: deployer,
    log: true,
    autoMine: true,
    args: [],
    ...
    contract: {
      abi: DropERC1155__factory.abi as any,
      bytecode: DropERC1155__factory.bytecode,
    },
  });
...
export default func;
func.tags = ['all', "1004", "1155-collection"];