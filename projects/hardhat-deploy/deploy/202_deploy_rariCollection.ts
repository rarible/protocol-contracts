...
import { ERC721RaribleMinimal, ERC721RaribleMinimal__factory } from "@rarible/tokens/js";
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    try {
        const receipt = await execute(contractName, { from: deployer, log: true }, "createToken(string,string,string,string,address[],uint256)", 
            "Cats Electroneum v3",
            "CATSELV3",
...
export default func;
func.tags = ['deploy-rari-collection-with-items', '202'];
