...
const NEW_OWNER_BY_CHAIN_ID: Record<number, { network: string; newOwner: string }> = {
  ...
  137:        { network: "polygon_mainnet",  newOwner: "0x735092F168FaeDeeBA11eDAa765455ecFf3C53b7" },
  ...
  999:        { network: "hyper_evm",        newOwner: "0x735092F168FaeDeeBA11eDAa765455ecFf3C53b7" },
