...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  console.log('\n=== Starting DropERC721FlatFeeC Deployment ===');
  ...
  console.log('\nDeploying DropERC721FlatFeeC contract...');
  const deployResult = await deploy('DropERC721FlatFeeC', {
    from: deployer,
    log: true,
    autoMine: true,
    args: [],
...
export default func;
func.tags = ["all", "1009", "721-flat-fee-collection-c"];
