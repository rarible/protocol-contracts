...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  console.log('\n=== Starting DropERC1155FlatFee Deployment ===');
  ...
  console.log('\nDeploying DropERC1155FlatFee contract...');
  const deployResult = await deploy('DropERC1155FlatFee', {
    from: deployer,
    log: true,
    autoMine: true,
    args: [],
...
export default func;
func.tags = ["all", "1008", "1155-flat-fee-collection"];