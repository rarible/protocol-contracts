...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  console.log('\n=== Starting DropERC721FlatFee Deployment ===');
  ...
  console.log('\nDeploying DropERC721FlatFee contract...');
  const deployResult = await deploy('DropERC721FlatFee', {
    from: deployer,
    log: true,
    autoMine: true,
    args: [],
...
export default func;
func.tags = ["all", "1007", "721-flat-fee-collection"];