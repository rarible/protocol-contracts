...
export interface TestERC721RoyaltiesV2Interface extends utils.Interface {
  functions: {
...
export interface TestERC721RoyaltiesV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestERC721RoyaltiesV2Interface;
