...
export interface TestERC721WithRoyaltiesV2OwnableUpgradeableInterface
...
export interface TestERC721WithRoyaltiesV2OwnableUpgradeable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestERC721WithRoyaltiesV2OwnableUpgradeableInterface;
