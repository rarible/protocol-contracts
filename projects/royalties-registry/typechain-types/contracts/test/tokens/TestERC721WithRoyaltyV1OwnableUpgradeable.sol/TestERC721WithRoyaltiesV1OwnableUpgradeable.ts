...
export interface TestERC721WithRoyaltiesV1OwnableUpgradeableInterface
...
export interface TestERC721WithRoyaltiesV1OwnableUpgradeable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestERC721WithRoyaltiesV1OwnableUpgradeableInterface;
