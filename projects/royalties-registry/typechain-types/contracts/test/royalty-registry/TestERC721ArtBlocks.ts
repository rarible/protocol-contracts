...
export interface TestERC721ArtBlocksInterface extends utils.Interface {
  functions: {
...
export interface TestERC721ArtBlocks extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestERC721ArtBlocksInterface;
