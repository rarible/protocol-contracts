...
export interface ERC1155BaseInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "balanceOfBatch" | "baseURI" | "burn" | "burnBatch" | "contractURI" | "getCreators" | "getRaribleV2Royalties" | "isApprovedForAll" | "mintAndTransfer" | "name" | "owner" | "renounceOwnership" | "royaltyInfo" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setBaseURI" | "supportsInterface" | "symbol" | "transferFromOrMint" | "transferOwnership" | "updateAccount" | "uri"): FunctionFragment;
