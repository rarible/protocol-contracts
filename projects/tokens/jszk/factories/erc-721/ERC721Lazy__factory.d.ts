...
import type { ERC721Lazy, ERC721LazyInterface } from "../../erc-721/ERC721Lazy";
export declare class ERC721Lazy__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ERC721Lazy;
}
