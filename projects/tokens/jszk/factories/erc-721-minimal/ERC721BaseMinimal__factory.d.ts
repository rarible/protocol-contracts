...
import type { ERC721BaseMinimal, ERC721BaseMinimalInterface } from "../../erc-721-minimal/ERC721BaseMinimal";
export declare class ERC721BaseMinimal__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ERC721BaseMinimal;
}
