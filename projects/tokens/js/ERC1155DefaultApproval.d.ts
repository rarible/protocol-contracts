...
export interface ERC1155DefaultApprovalInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "balanceOfBatch" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "supportsInterface" | "uri" | "isApprovedForAll"): FunctionFragment;
...
export interface ERC1155DefaultApproval extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1155DefaultApprovalInterface;
