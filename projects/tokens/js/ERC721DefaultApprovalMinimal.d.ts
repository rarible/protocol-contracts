...
export interface ERC721DefaultApprovalMinimalInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "balanceOf" | "getApproved" | "name" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "isApprovedForAll"): FunctionFragment;
...
export interface ERC721DefaultApprovalMinimal extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC721DefaultApprovalMinimalInterface;
