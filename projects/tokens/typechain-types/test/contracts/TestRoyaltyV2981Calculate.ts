...
export interface TestRoyaltyV2981CalculateInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "baseURI()": FunctionFragment;
    "burn(uint256)": FunctionFragment;
    "calculateRoyaltiesTest(address,uint256)": FunctionFragment;
...
export interface TestRoyaltyV2981Calculate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestRoyaltyV2981CalculateInterface;
