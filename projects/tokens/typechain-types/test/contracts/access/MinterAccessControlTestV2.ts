...
export interface MinterAccessControlTestV2Interface extends utils.Interface {
  functions: {
    "V2()": FunctionFragment;
...
export interface MinterAccessControlTestV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MinterAccessControlTestV2Interface;
