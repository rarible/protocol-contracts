...
contract("MetaTxTokenTest", accounts => {
  ...
  before(async () => {
    ...
    erc721NoMetaTx = await deployProxy(ERC721NoMetaTx, ["Rarible", "RARI", "ipfs:/", "", ZERO_ADDRESS, ZERO_ADDRESS, accounts[0]], { initializer: '__ERC721Rarible_init_proxy' });
    erc721WithMetaTx = await deployProxy(ERC721MetaTx, ["Rarible", "RARI", "ipfs:/", "", ZERO_ADDRESS, ZERO_ADDRESS, accounts[0]], { initializer: '__ERC721Rarible_init_proxy' });
    ...
    erc1155NoMetaTx = await deployProxy(ERC1155NoMetaTx, ["Rarible", "RARI", "ipfs:/", "", ZERO_ADDRESS, ZERO_ADDRESS, accounts[0]], { initializer: '__ERC1155Rarible_init_proxy' });
    erc1155WithMetaTx = await deployProxy(ERC1155MetaTx, ["Rarible", "RARI", "ipfs:/", "", ZERO_ADDRESS, ZERO_ADDRESS, accounts[0]], { initializer: '__ERC1155Rarible_init_proxy' });
