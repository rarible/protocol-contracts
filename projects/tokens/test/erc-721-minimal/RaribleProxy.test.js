...
contract("ERC721Rarible minimal", accounts => {
  ...
  beforeEach(async () => {
    ...
    await token.__ERC721Rarible_init_proxy(name, "RARI", "https://ipfs.rarible.com", "https://ipfs.rarible.com", whiteListProxy, proxyLazy.address, tokenOwner);
  });
  ...
  it("mint and transfer by minter, and token created by ERC721Factory ", async () => {
    ...
    factory = await ERC721Factory.new(beacon.address, transferProxy.address, proxyLazy.address, accounts[0]);
