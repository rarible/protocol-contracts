...
import { encBigNumber, ERC721, ETH, ZERO } from "@rarible/exchange-v2/test-hardhat/utils";
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    // Now match
    const tx = await exchange.cancel(leftOrder,{ gasLimit: 1_000_000});
    console.log("cancelOrder =>", tx.hash);
};

export default func;
func.tags = ['run-cancel-order', '209'];
