...
// import { RoyaltiesRegistry, RoyaltiesRegistry__factory } from "@rarible/royalties-registry";
...
//     const royaltiesRegistryDeployment = await hre.deployments.get("RoyaltiesRegistry");
//     const royaltiesRegistry: RoyaltiesRegistry = RoyaltiesRegistry__factory.connect(royaltiesRegistryDeployment.address, makerRight);
//     royaltiesRegistry.setRoyaltiesType(erc721Address, 1, makerRight.address);
