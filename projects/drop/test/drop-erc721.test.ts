...
import {
	...
	IDrop,
	DropERC721RariFee,
	DropERC721RariFee__factory,
	RariFeesConfig,
} from "../typechain-types"
import { SignerWithAddress } from "@nomiclabs/hardhat-ethers/signers"
import { expect } from "chai"
import { randomAddress } from "hardhat/internal/hardhat-network/provider/utils/random"
import { RariFeesDrop } from "../typechain-types/contracts/final/DropERC721RariFee"
...
describe("DropERC721", () => {
	...
	let factory: DropERC721RariFee__factory
	let impl: DropERC721RariFee
	let proxyFactory: EIP173Proxy__factory
	let proxy: EIP173Proxy
	let drop: DropERC721RariFee
	...
	before(async () => {
		...
		factory = await hre.ethers.getContractFactory("DropERC721RariFee")
	...
	async function initialize(fees: FeesStruct, config: DropContractsConfig) {
		...
		await drop.lazyMint(1000, "ipfs://base", "0x")
