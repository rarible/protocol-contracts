...
abstract contract AbstractRaribleExchangeWrapper is Ownable, ERC721Holder, ERC1155Holder, IsPausable {
    using LibTransfer for address;
    using BpLibrary for uint;
    using SafeMath for uint;

    //marketplaces
    function wyvernExchange() virtual public returns(address);
    function exchangeV2() virtual public returns(address);
    function seaPort_1_1() virtual public returns(address);
    function x2y2() virtual public returns(address);
    function looksRare() virtual public returns(address);
    function sudoswap() virtual public returns(address);
    function seaPort_1_4() virtual public returns(address);
    function looksRareV2() virtual public returns(address);
    function blur() virtual public returns(address);
    function seaPort_1_5() virtual public returns(address);
    function seaPort_1_6() virtual public returns(address);

    function weth() virtual public returns(address);
