...
contract TWCreateX {
     ...
     */
    event ContractCreation2(address indexed newContract, bytes32 indexed salt);
    ...
    function deployCreate2(bytes32 salt, bytes memory initCode) public payable returns (address newContract) {
        ...
        emit ContractCreation2({newContract: newContract, salt: guardedSalt});
    }
    ...
    function deployCreate2Clone(
        ...
        emit ContractCreation2({newContract: proxy, salt: guardedSalt});
