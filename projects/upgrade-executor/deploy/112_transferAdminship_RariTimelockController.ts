...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`Transfering adminship of contract: RariTimelockController, at:${contractAddress}`)
  console.log(`oldOwner=${oldOwner}, newOwner=${newOwner}`)

  await transferTimelockAdminRole(settings.RariTimelockController, newOwner, signer)

  console.log()
};
export default func;
func.tags = ['ownership-transfer', 'RariTimelockController'];
